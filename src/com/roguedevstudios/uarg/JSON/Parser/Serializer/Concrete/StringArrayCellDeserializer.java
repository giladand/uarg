...
/********************************************
*  String[] Cell Deserializer			*
*   File Name: 								*
*   StringArrayCellDeserializer.java 	*
*                            	   	    	*
*   Deserializes JSON						*
 ...
 * @since 1.0
 */
public class StringArrayCellDeserializer implements JsonDeserializer<ICell<String[]>> {
	...
	public ICell<String[]> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		v = new Cell<String[]>(_name, _id, _requiresInput, _description, _format, _value);
