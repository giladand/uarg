...
public class SampleController<V> implements Initializable {
    ...
    // Added Code: Filtered Search Bar 11/27/2018
    private ObservableList<VariableTableView> masterData = FXCollections.observableArrayList();
    ...
    */
	...
	// Added Code: Table Search Bar 
     ...
     {
         filteredData.setPredicate(ResidentialServiceLines -> {
             ...
             if (ResidentialServiceLines.getFirstName().toLowerCase().contains(lowerCaseFilter)) {
                 return true; 
             } else if (ResidentialServiceLines.getLastName().toLowerCase().contains(lowerCaseFilter)) {
                 return true; 
             }
             return false; 
         });
     ...
     ObservableList<VariableTableView<V>> sortedData = new SortedList<>(filteredData);
     
    
     sortedData.comparatorProperty().bind(ResidentialServiceLines.comparatorProperty());
     
     
     ResidentialServiceLines.setItems(sortedData);
 }
