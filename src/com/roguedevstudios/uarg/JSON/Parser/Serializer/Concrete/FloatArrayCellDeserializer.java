...
*   File Name: 								*
*   FloatArrayCellDeserializer.java 	*
*                            	   	    	*
*   Deserializes JSON						*
 ...
 * @since 1.0
 */
public class FloatArrayCellDeserializer implements JsonDeserializer<ICell<Float[]>> {
	...
	public ICell<Float[]> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		v = new Cell<Float[]>(_name, _id, _requiresInput, _description, _format, _value);
