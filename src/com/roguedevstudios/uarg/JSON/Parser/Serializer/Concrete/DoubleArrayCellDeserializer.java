...
/********************************************
*  Double[] Cell Deserializer			*
*   File Name: 								*
*   DoubleArrayCellDeserializer.java 	*
*                            	   	    	*
*   Deserializes JSON						*
 ...
 * @since 1.0
 */
public class DoubleArrayCellDeserializer implements JsonDeserializer<ICell<Double[]>> {

	/**
	 * Deserializes into a Cell<Double> type
	...
	public ICell<Double[]> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		v = new Cell<Double[]>(_name, _id, _requiresInput, _description, _format, _value);
