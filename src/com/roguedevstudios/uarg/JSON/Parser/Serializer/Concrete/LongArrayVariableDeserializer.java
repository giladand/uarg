 ...
 * @since 1.0
 */
public class LongArrayVariableDeserializer implements JsonDeserializer<IFact<Long[]>> {
	...
	public IFact<Long[]> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		v = new Fact<Long[]>(_name, _id, _requiresInput, _description, _value);
